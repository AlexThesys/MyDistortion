...
//------------------------------------------------------------------------
class MyDistortionProcessor : public Steinberg::Vst::AudioEffect
{
public:
	MyDistortionProcessor ();
	~MyDistortionProcessor () SMTG_OVERRIDE;

    // Create function
	static Steinberg::FUnknown* createInstance (void* /*context*/) 
	{ 
		return (Steinberg::Vst::IAudioProcessor*)new MyDistortionProcessor; 
	}
	...
	//------------------------------------------------------------------------
protected:
	Steinberg::Vst::ParamValue _coef_pos;	// 0.1f ... 2.0f
